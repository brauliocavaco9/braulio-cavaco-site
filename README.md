...
O site é exportado como HTML estático, por isso **não precisa de nenhum adaptador
especial**. Os dois formulários funcionam através de *Cloudflare Pages Functions*
(a pasta `functions/`), que a Cloudflare corre automaticamente.
...
Variáveis de ambiente a definir no painel do projecto:

| Nome | Valor |
|---|---|
| `NEXT_PUBLIC_WHATSAPP_NUMBER` | o teu número, ex. `351912345678` |
| `RESEND_API_KEY` | chave da conta Resend |
| `NOTIFY_EMAIL_TO` | email onde queres receber candidaturas |
| `EMAIL_FROM` | opcional; só depois de verificares domínio na Resend |

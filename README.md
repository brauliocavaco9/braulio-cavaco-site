...
- Domínio próprio já configurado: `brauliocavaco.com`, ligado via Cloudflare (SSL
  automático). Se um dia mudares de domínio, actualiza-o em três sítios:
  `metadataBase` em `src/app/layout.tsx`, e os endereços em `public/robots.txt` e
  `public/sitemap.xml`

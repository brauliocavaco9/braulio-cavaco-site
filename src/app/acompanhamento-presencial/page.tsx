...
export const metadata: Metadata = {
  ...
  description: "Treino presencial individual em Viseu, CityGym. Vagas extremamente limitadas, sujeitas a disponibilidade.",
};
      ...
      <section className="pt-16 pb-16 md:pt-24 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div className="mt-6 inline-block border border-gold px-4 py-3">
            <p className="text-sm text-gold">Vagas extremamente limitadas</p>
            <p className="text-xs text-muted mt-1">
              Por ser um acompanhamento individual, aceito apenas um número reduzido de alunos
              presenciais de cada vez.
            </p>
          </div>

...
export const metadata: Metadata = {
  ...
  description: "Treino presencial individual em Viseu, CityGym. Agenda quase preenchida, poucos horários disponíveis.",
};
...
const POINTS = [
  ...
  "Agenda praticamente cheia, com muito poucos horários livres",
];
      ...
      <section className="pt-16 pb-16 md:pt-24 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div className="mt-6 inline-block border border-gold px-4 py-3">
            <p className="text-sm text-gold">Agenda quase preenchida</p>
            <p className="text-xs text-muted mt-1 max-w-xs">
              Tenho a agenda de treino presencial praticamente cheia, com muito poucos
              horários disponíveis. Pergunta se ainda tenho o horário que pretendes disponível.
            </p>
          </div>

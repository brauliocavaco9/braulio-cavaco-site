...
export default function AcompanhamentoOnlinePage() {
  return (
    <div className="mx-auto max-w-6xl px-5">
      ...
      <section className="border-t border-hairline py-20 md:py-24">
        <h2 className="font-serif text-2xl md:text-3xl text-ink mb-8 max-w-md">
          Porquê pagar por acompanhamento, e não seguir um plano gratuito?
        </h2>
        <div className="max-w-2xl">
          <p className="text-ink2 leading-relaxed">
            Um plano genérico fica parado — recebes um documento e a partir daí estás sozinho.
          </p>
          <p className="text-ink2 leading-relaxed mt-4">
            O acompanhamento é diferente porque não fica parado. Começas com determinado
            treino, determinadas cargas, determinada disponibilidade e determinado contexto.
            Ao longo do tempo, acompanho o teu feedback, observo a tua evolução e tomo decisões
            com base no que está realmente a acontecer contigo — não no que aconteceria, em
            teoria, a uma pessoa qualquer.
          </p>
          <p className="font-serif italic text-lg text-ink mt-6">
            Esse acompanhamento contínuo é o verdadeiro produto.
          </p>
        </div>
      </section>

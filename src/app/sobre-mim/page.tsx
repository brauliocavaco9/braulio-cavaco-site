          ...
          <div className="flex flex-col gap-6 text-ink2 leading-relaxed">
            ...
            <section>
              ...
              <p>
                ...
                físicas ou dores que querem continuar ou começar a treinar, mas têm medo da
                dor ou das próprias limitações. O objectivo pode ser ganhar massa muscular,
                perder gordura, melhorar a composição corporal, ou simplesmente recuperar
                confiança no próprio corpo. Ao longo do meu percurso, já trabalhei com
                praticamente todo o tipo de problemas osteomioarticulares e com dor crónica.
              </p>
              <p className="mt-4">

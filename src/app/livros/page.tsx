...
export const metadata: Metadata = {
  title: "Livros",
  description: "Guias práticos de alimentação e composição corporal — individuais ou em pack.",
};
  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-16 md:py-20">
      ...
      <p className="text-ink2 max-w-xl mb-14">
        Guias práticos para compreender melhor alimentação e composição corporal —
        sem fórmulas milagrosas. Livros digitais (PDF), em formato individual ou em pack, com desconto.
      </p>

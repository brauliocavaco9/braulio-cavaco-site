      ...
      <div className="mx-auto max-w-6xl px-5 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            className="hidden md:inline text-sm border border-hairline hover:border-gold hover:text-gold px-4 py-2 transition-colors"
          >
            Falar comigo
          </a>
      ...
      {open && (
        <nav className="md:hidden border-t border-hairline bg-base px-5 py-6 flex flex-col gap-5">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-base text-gold pt-3 border-t border-hairline"
          >
            Falar comigo
          </a>
        </nav>

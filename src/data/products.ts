...
export const PRODUCTS: Product[] = [
  {
    ...
    description:
      "Um guia alimentar prático de 12 semanas para perder gordura sem dietas extremas — défice calórico bem calculado, orientação para refeições sociais e uma estratégia que cabe na tua rotina real.",
    audience:
      "Pessoas iniciantes a intermédias que querem perder gordura de forma sustentável, sem restrições impossíveis de manter.",
    whatsInside:
      "Protocolo alimentar estruturado em 12 semanas, tabelas de acompanhamento, orientação para refeições sociais e glossário de termos.",
    whatYouLearn:
    ...
    faq: [
      { question: "É uma dieta rígida, com alimentos proibidos?", answer: "Não — o guia é flexível e pensado para se adaptar à tua rotina, sem restrições impossíveis de manter." },
      { question: "Este guia inclui treino?", answer: "Não. É um guia exclusivamente alimentar, focado em nutrição para perda de gordura." },
    ],
    priceCents: 2200,
    currency: "eur",
    coverUrl: "/placeholders/capa-emagrecimento.jpg",
  },
  {
    slug: "guia-hipertrofia",
    kind: "individual",
    title: "Guia de Hipertrofia",
    shortDesc: "Plano alimentar de 20 semanas para apoiar o ganho de massa muscular.",
    description:
      "Um guia alimentar de 20 semanas para apoiar o ganho de massa muscular, com orientação nutricional prática e ajuste de calorias e macros ao longo do processo — sem excessos desnecessários.",
    audience: "Pessoas iniciantes a intermédias que querem apoiar o ganho de massa muscular através da alimentação.",
    whatsInside: "Plano alimentar de 20 semanas, tabelas de acompanhamento de calorias e macros, guia de creatina e reverse diet.",
    whatYouLearn: "Como ajustar calorias e macros ao longo do tempo para apoiar o ganho de massa muscular, sem estagnação.",
    structure: [
      { title: "Fundamentos da alimentação para hipertrofia", items: ["Excedente calórico", "Distribuição de macros"] },
      { title: "As 20 semanas", items: ["Fase de adaptação alimentar", "Fase de ajuste calórico", "Reverse diet"] },
    ],
    faq: [
      { question: "Serve para mulheres?", answer: "Sim — é igualmente indicado para homens e mulheres, com nuance específica para o público feminino onde é relevante." },
      { question: "Este guia inclui treino?", answer: "Não. É um guia exclusivamente alimentar, focado em nutrição para apoiar o ganho de massa muscular." },
    ],
    priceCents: 2500,
    currency: "eur",
    coverUrl: "/placeholders/capa-hipertrofia.jpg",
  },
  {
    ...
    whatYouLearn: "Como variar refeições mantendo o teu objectivo alimentar.",
    structure: [
    ...
    priceCents: 1900,
    currency: "eur",
    coverUrl: "/placeholders/capa-receitas.jpg",
  },
  {
    slug: "pack-definicao",
    kind: "pack",
    ...
    currency: "eur",
    coverUrl: "/placeholders/capa-pack-definicao.jpg",
  ...
  },
  {
    ...
    description:
      "A combinação para quem quer apoiar o ganho de massa muscular com um plano alimentar bem definido e ter receitas práticas para sustentar o volume alimentar necessário.",
    audience: "Quem quer apoiar o ganho de massa muscular sem cair em refeições repetitivas.",
    whatsInside: "Os dois guias completos: plano alimentar de 20 semanas + 100 receitas fitness.",
    whatYouLearn: "Tudo o que está nos dois guias individuais, com o benefício de aplicares as receitas directamente ao teu plano alimentar de ganho de massa.",
    structure: [
    ...
    currency: "eur",
    coverUrl: "/placeholders/capa-pack-volume.jpg",
  ...
  },
  {
    ...
    currency: "eur",
    coverUrl: "/placeholders/capa-pack-nutricao.jpg",
  ...
  },
  {
    ...
    whatYouLearn: "As duas estratégias alimentares completas, mais 100 receitas para aplicar em qualquer uma delas.",
    structure: [
      { title: "Guia de Emagrecimento", items: ["Protocolo completo de 12 semanas"] },
      { title: "Guia de Hipertrofia", items: ["Protocolo completo de 20 semanas"] },
      { title: "100 Receitas Fitness", items: ["100 receitas com macros validados"] },
    ...
    currency: "eur",
    coverUrl: "/placeholders/capa-pack-completo.jpg",
